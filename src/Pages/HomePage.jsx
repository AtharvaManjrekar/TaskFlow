            ...
            <div className="container">
                ...
                <div className="upper_content md:flex mb-5">
                    ...
                    <div className="left_container p-2 md:p-4 md:mt-8">
                        <h2 className='text-6xl font-extrabold font-outfit m-2 text-center md:text-left md:mt-18 md:mb-12 mb-15 leading-17'>Master your Productivity with TaskFlow</h2>
                ...
                {/* Second Container */}
                <div className="second_container w-full bg-[rgba(58,153,255,0.52)] pt-10 p-5">
                ...
                <div className="outer_container3 bg-[rgb(248,248,248)] md:p-10 py-10 px-2 border-b-gray-500">
                    <div className="container3 w-full md:w-4/5  block md:m-auto md:mb-20 md:mt-10 ">
                        <div className="inner_container_3  p-5 m-2 bg-gray-100 rounded-4xl border border-gray-300 ">
                            <h1 className='text-center text-4xl md:text-6xl md:my-10 font-outfit font-extrabold my-5 '>Start Organizing Today, Free Forever</h1>
                            <h3 className='text-center text-xl text-gray-600 md:text-2xl md:my-10 font-nunito font-light my-5'>No credit card required. No hidden fees. Just pure productivity. Get started in <br className='hidden md:inline-block' /> seconds and see the difference in your workflow.</h3>
                            <div className="button_cta flex justify-center mb-5">
                                <Link to="register" className='m-5 bg-blue-900 text-white  h-12 flex px-6 text-xl py-3 rounded-xl font-nunito cursor-pointer justify-center items-center md:w-60 shadow-lg shadow-gray-400 transition-transform duration-200 hover:-translate-y-1'>Get Started Free
                                    <div className="arrow">
                                        <FontAwesomeIcon icon={faArrowRightLong} className="text-white ml-2 items-center" />
                                    </div>
                                </Link>
